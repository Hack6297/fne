  ...
  useEffect(function() {
    ...
    try {
      ...
      var defs: Record<string,any> = {
        ...
        evt_receive:{message0:'when I receive %1',args0:[{type:'field_input',name:'MSG',text:'message1'}],colour:'#E6A822',hat:true,next:true},
        ...
        ctrl_broadcast:{message0:'broadcast %1',args0:[{type:'field_input',name:'MSG',text:'message1'}],colour:'#E6A822',prev:true,next:true},
        ctrl_broadcast_wait:{message0:'broadcast %1 and wait',args0:[{type:'field_input',name:'MSG',text:'message1'}],colour:'#E6A822',prev:true,next:true},
      ...
      var toolbox = {
        ...
        contents: [
          {kind:'category',name:'⚡ Events',colour:'#E6A822',contents:[
            ...
            {kind:'block',type:'ctrl_broadcast'},{kind:'block',type:'ctrl_broadcast_wait'},
          ]},
